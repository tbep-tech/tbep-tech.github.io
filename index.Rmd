...
- [![Travis build status](https://travis-ci.org/tbep-tech/wqtrends.svg?branch=master)](https://travis-ci.org/tbep-tech/wqtrends) [wqtrends](https://tbep-tech.github.io/wqtrends/): R package to assess water quality trends for long-term monitoring data in estuaries using Generalized Additive Models. See the [vignette](https://tbep-tech.github.io/wqtrends/articles/introduction.html) for a detailed overview of the package.
